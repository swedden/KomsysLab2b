...
public class AudioStreamUDP {
	...
	public AudioStreamUDP() throws IOException {
		this.receiverSocket = new DatagramSocket(8888);
		//receiverSocket.setSoTimeout(TIME_OUT);
		this.senderSocket = new DatagramSocket(9999);
...
class Receiver implements Runnable{
	...
	public void run() {
    	...
    	try {
    		...
    		System.out.println("State.Receiver socket is closed");
...
class Sender implements Runnable {
	...
	public void run() {
    	...
    	try {
    		...
    		System.out.println("State.Sender socket is closed");
